  ...
  e(function () {
    ...
    e(document).on(
      ...
      e('.lightbox-wrapper').each(function () {
        e('.navbar .navbar-nav .nav-link[href^="#' + this.id + '"]')
          .length || e(this).hide();
      }),
      ...
      t('#resume .skills-section', function () {
        var t = function () {
          e('#resume .skills-section .single-skill').each(
            function () {
              var t = Math.min(
                  100,
                  Math.max(0, e(this).data('percentage'))
                ),
      ...
      t('#portfolio .portfolio-section', function () {
        ...
        t.imagesLoaded(function () {
          t.isotope({
            itemSelector:
              '#portfolio .portfolio-section .single-item',
      ...
      t('#contact .contact-section', function () {
        e('#contact .contact-section .contact-form').on(
          'submit',
          function (t) {
            var i = e(this),
